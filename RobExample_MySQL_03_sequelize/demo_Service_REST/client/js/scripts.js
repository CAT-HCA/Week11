...
$(document).ready(function() {
    ...
    userForm.addEventListener('submit', function(evt) {
        ...
        if (validateInput(userName, email, password, msg)) {
            ...
            var userObj = { userName: userName.value, email: email.value, password: password.value, isAdmin: isAdminSelected };
    ...
    editBtn.addEventListener('click', function() {
        var isAdminSelected = isAdmin.checked ? 1 : 0;
        var userObj = { id: parseInt(userToDelete), userName: userName.value, email: email.value, password: password.value, isAdmin: isAdminSelected };
